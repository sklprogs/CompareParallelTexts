...
feature_pos='Feature "%s" найден в позиции %d списка признаков.'
feature='Feature: '
...
hint_wallet_no='Copy the E-wallet number'
hint_watch_clipboard='Watch clipboard'
...
msexcel_export_failure='Failed to export the file "%s" using Microsoft Excel!'
msexcel_not_found='Unable to locate Microsoft Excel!'
...
msword_not_found='Unable to locate Microsoft Word!'
